...
func handleStateMessages(bot *tgbotapi.BotAPI, db *sql.DB, update tgbotapi.Update, user User) {
    ...
    case "broadcast_message":
        ...
        if update.Message.Photo != nil && len(update.Message.Photo) > 0 {
            ...
            fileID := tgbotapi.FileID(photo.FileID)
            broadcastMsg = tgbotapi.NewPhoto(0, fileID)
            ...
            broadcastMsg = tgbotapi.NewVideo(0, fileID)
            if update.Message.Caption != "" {
        ...
        for _, uid := range users {
            ...
            case *tgbotapi.PhotoConfig:
                msgToSend = tgbotapi.NewPhoto(uid, tgbotapi.FileID(msg.File.FileID))
            ...
            case *tgbotapi.VideoConfig:
                msgToSend = tgbotapi.NewVideo(uid, tgbotapi.FileID(msg.File.FileID))
