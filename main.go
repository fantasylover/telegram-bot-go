    ...
    case "broadcast_message":
        ...
        for _, uid := range users {
            ...
            case *tgbotapi.VideoConfig:
                msg.ChatID = uid
            case tgbotapi.MessageConfig: // Changed from *tgbotapi.MessageConfig to tgbotapi.MessageConfig
                msg.ChatID = uid
                broadcastMsg = msg // Update the interface with the modified value
            default:
