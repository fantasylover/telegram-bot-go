        ...
        for _, u := range users {
            if u.Banned == 0 {
                ...
                if update.Message.Photo != nil && len(update.Message.Photo) > 0 {
                    photo := tgbotapi.NewPhoto(u.UserID, update.Message.Photo[len(update.Message.Photo)-1].FileID)
                    ...
                    video := tgbotapi.NewVideo(u.UserID, update.Message.Video.FileID)
                    ...
                    doc := tgbotapi.NewDocument(u.UserID, update.Message.Document.FileID)
