...
// --- Start of Part 10A: QR Code and User States ---
...
// --- End of Part 10A: QR Code and User States ---




// --- Start of Part 10B: Admin State Handling (Broadcast and User Info) ---
// --- Start of Part 10B: Admin States (Broadcast and User Info) ---
func handleStateMessages(bot *tgbotapi.BotAPI, db *sql.DB, update tgbotapi.Update, user User) {
    userID := update.Message.From.ID
    state := user.State
...
// --- End of Part 10B: Admin States (Broadcast and User Info) ---


// --- Start of Part 10C: Admin State Handling (Settings) and Admin Actions ---
// --- Start of Part 10C: Admin States (Settings) and Actions ---
func handleStateMessages(bot *tgbotapi.BotAPI, db *sql.DB, update tgbotapi.Update, user User) {
    userID := update.Message.From.ID
    state := user.State
...
// --- End of Part 10C: Admin States (Settings) and Actions ---
