    ...
    for _, channel := range channels {
        ...
        chat, err := bot.GetChat(tgbotapi.ChatInfoConfig{
            ChatConfig: tgbotapi.ChatConfig{
                ChatID: channel, // This is a string like "@ChannelName"
            },
        })
        if err != nil {
        ...
        chatConfig := tgbotapi.GetChatMemberConfig{
            ChatConfigWithUser: tgbotapi.ChatConfigWithUser{
                ChatID: chat.ID, // Use numeric ID (int64) here
                UserID: userID,
            },
        }
...
func handleStateMessages(bot *tgbotapi.BotAPI, db *sql.DB, update tgbotapi.Update, user User) {
    ...
    case "withdraw_amount":
        ...
        if paymentChannel != "" {
            ...
            chat, err := bot.GetChat(tgbotapi.ChatInfoConfig{
                ChatConfig: tgbotapi.ChatConfig{
                    ChatID: paymentChannel, // String like "@YourPaymentChannel"
                },
            })
            if err != nil {
    ...
    case "add_channel":
        ...
        chat, err := bot.GetChat(tgbotapi.ChatInfoConfig{
            ChatConfig: tgbotapi.ChatConfig{
                ChatID: channel, // String like "@ChannelName"
            },
        })
        if err != nil {
        ...
        _ = chat.ID // We don’t store it, just validate
